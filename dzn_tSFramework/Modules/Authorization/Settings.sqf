...
GVAR(RuleList) = [
  ...
  , ROLE "1'6 Platoon Leader@1'6" HAS [ALL_ALLOWED] PERMISSIONS
  , ROLE "Platoon Sergeant" HAS [ALL_ALLOWED] PERMISSIONS
  , ROLE "1'1 Squad Leader@1'1" HAS [ARTILLERY_ONLY_ALLOWED] PERMISSIONS
  , ROLE "1'2 Squad Leader@1'2" HAS [ARTILLERY_ONLY_ALLOWED] PERMISSIONS
